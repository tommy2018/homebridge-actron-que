...
export class QuietModeAccessory {
    ...
    constructor(
        ...
        .setCharacteristic(this.platform.Characteristic.Model, "Quiet Mode Switch")
    ...
    private updateDeviceCharacteristics() {
        this.platform.log.info("Updating quiet mode switch characteristics");
    ...
    private async setOn(value: CharacteristicValue) {
        ...
        if (value === true) {
            this.platform.log.info("Setting quiet mode to on");
        } else {
            this.platform.log.info("Setting quiet mode to off");
        }

        await this.platform.actronQueApi.setQuietModeAsync(value === true);

        this.airConState.quietMode = value === true;
        this.service.updateCharacteristic(this.platform.Characteristic.Active, this.getOn());
    }

    private getOn(): CharacteristicValue {
        return this.airConState.quietMode === true;
    }
}
